    ...
    <video id="bgvideo" autoPlay loop muted>
      ...
      <ScrollAnimation animateIn="animate__flipInX" animateOnce={true}>
        ...
        >
          <span className="achievementdesc">
            Team "Green genesis" won the Polygon Pool track where we built a
            Decentralized funding project with verifications and dispute
            handlings secured by blockchain
          </span>
        </div>
        <br />
        <div
        ...
        >
          <a
            href="https://github.com/SabariGanesh-K/lumos-letsgo"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/posts/sabariganeshk_web3-buidlforweb3-blockchain-activity-6995690747756699648-_Q2v?utm_source=share&utm_medium=member_desktop"
            target="_blank"
            style={{ textDecoration: "none" }}
            rel="noreferrer"
          >
      ...
      <ScrollAnimation animateIn="animate__flipInX" animateOnce={true}>
        <div
          ...
          style={{ display: "flex", justifyContent: "center" }}
        >
          <div className="achievementtitle">🏆👕 HACTOBERFEST </div>
        </div>
        <div
          className="container"
          style={{ display: "flex", justifyContent: "center" }}
